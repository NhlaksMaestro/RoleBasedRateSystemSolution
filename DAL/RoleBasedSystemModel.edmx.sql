...
-- --------------------------------------------------
-- Date Created: 11/07/2015 11:03:40
-- Generated from EDMX file: C:\Art\RoleBasedRateSystemSolution\DAL\RoleBasedSystemModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[DepartmentRoles]', 'U') IS NOT NULL
    DROP TABLE [dbo].[DepartmentRoles];
GO
...
-- Creating primary key on [EmployeeId], [ProjectId], [ProjectRoleId] in table 'EmployeeProjects'
...
-- Creating foreign key on [ProjectRoleId] in table 'EmployeeProjects'
ALTER TABLE [dbo].[EmployeeProjects]
